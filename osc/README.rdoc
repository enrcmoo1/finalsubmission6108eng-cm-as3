...
Once you have navigated to the correct directory of this repository folder, ensure that you run a 'bundle install' in order for gems required for website functionality are installed. 
...
A user authentication system has been included in this website. A register page has been built which allows a user to sign up to the Oval Ski Club website by filling in username, email and password details.
From this they can login with their details and see that they are logged in on the bottom left hand corner of the webpage.
